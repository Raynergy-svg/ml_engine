    ...
    <div className="flex flex-col gap-4">
      ...
      <Card className="p-3">
        ...
        <div className="grid grid-cols-2 gap-2 p-1 sm:grid-cols-3 lg:grid-cols-5">
          ...
          <Tile label="Autonomy" sub={data.autonomy_level == null ? "not in snapshot — add autonomy_level" : "bounded"}>
            {data.autonomy_level != null ? String(data.autonomy_level)
      ...
      <div className="grid gap-4 lg:grid-cols-2">
        ...
        <Card className="flex flex-col p-3">
          ...
          <div className="rounded-md border p-3 hairline">
            <div className="font-mono text-[14px] text-cyan">{data.current_action ?? "idle"}</div>
          ...
          {meta?.change_id ? (
            <div className="rounded-md border p-2.5 font-mono text-[11.5px] hairline">
              ...
              <div className="mt-0.5 text-[10.5px] text-faint tnum">{meta.change_id} · {meta.kind} · {shortTime(meta.updated_at)}</div>
            </div>
        ...
        <Card className="flex flex-col p-3">
          ...
          {ab?.last_action_label && (
            <div className="rounded-md border p-2.5 hairline">
              ...
              <span className="font-mono text-[12px] text-magenta">{ab.last_action_label}</span>
