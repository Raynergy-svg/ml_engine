...
def import_book(
    ...
    groups = (
        ...
        ({"no_forbidden_capabilities", "metric_surface_complete", "source_package_derivation_bound", "source_lineage_bound_in_partitions", "source_packages_quarantined"}, DispositionState.POLICY_VERIFIED, "capability, metric and source-derivation policy verified"),
