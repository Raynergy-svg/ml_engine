    ...
    def load_models(self, instrument: Optional[str] = None) -> None:
        ...
        if lgbm_momentum_path.exists():
            ...
            try:
                ...
                self._log_model_trained_at(lgbm_momentum_path, "LightGBM momentum", category="gates")
            except Exception as e:
                ...
                if xgb_path.exists():
                    ...
                    self._log_model_trained_at(xgb_path, "XGBoost momentum", category="gates")
        ...
        if self.use_rl_sizer:
            ...
            if rl_available and RLSizer is not None:
                ...
                if self.rl_sizer.load():
                    ...
                    self._log_model_trained_at(RL_MODEL_PATH, "RL position sizer", category="rl_sizer")
                else:
