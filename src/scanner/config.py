...
class ScannerConfig:
    ...
    # evidence and flips this — promotion requires evidence. The scanner's
    # book is lane-covered via hedged_shadow_lane.load_oanda_fx_book
    # (2026-07-18); the hook still passes through until >= 5 aligned
    # after-cost lane cycles exist for "oanda_fx", then modulates only when
    # this flag is ON.
