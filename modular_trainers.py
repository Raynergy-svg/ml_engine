...
def train_all_modular(
    ...
    Args:
        data: Dict from load_all_modular_data() with 'direction'/'tcn', 'xgboost', 'rf', 'ridge' keys
        config: Optional trainer configuration
        save_dir: Directory to save models
        use_transformer: If True, use Transformer for direction; if False, use TCN
    ...
    # 1. Direction Model (Transformer or TCN)
    logger.info("\n" + "="*50)
    if use_transformer:
