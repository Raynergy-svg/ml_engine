...
from cli.calibration import (
    _tier2_apply_calibration, _tier2_get_calibration_dict,
    _tier2_points_from_bins, _tier2_nll, _tier2_spearman,
    _tier2_clip_prob, _tier2_logit, _tier2_sigmoid,
...
from cli.models import _build_buddy_model_for_type
    ...
    *,
    ...
    try:
        ...
        if len(ensemble_predictions) != n_samples or len(prices) != n_samples:
            console.print(f"[yellow]RL training deferred: data shape mismatch[/yellow]")
