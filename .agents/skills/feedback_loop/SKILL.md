...
If `|shaped_reward| > 2 * sl_pips`, the trade is considered a significant outcome and an entry is appended to `.Codex/learnings.md`.
...
| `.Codex/learnings.md` | Markdown | Significant outcomes (>= 2R) appended as dated bullet entries |
