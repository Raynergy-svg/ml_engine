"""ML head (pure TensorFlow).

A reusable LSTM head that maps the shared (sequence_len, feature_dim) input into
an embedding vector.
"""
...
class MLEngineHead(tf.keras.Model):
    def __init__(
        self,
        *,
        hidden_size: int = 64,
