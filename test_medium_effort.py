...
from m1_metal_optimizer import CosineDecayRestarts  # noqa: E402
...
from src.training.buddy_training_helpers import _load_multi_pair_data  # noqa: F401, E402
print('✓ Multi-pair loader imports working!')

# 4. Test CLI command registration
print('\nTesting CLI command registration...')
from main import train_rl_sizer  # noqa: F401, E402
